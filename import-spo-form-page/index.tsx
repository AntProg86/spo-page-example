...
import { setFormModeImport, setObservableObjectImportExport } from '../reducer';
import { setFormMode } from '../../service-invoice-page/reducer';
...
const FormPage: React.FunctionComponent<Props> = () => {
  ...
  let pageTitle = LocalizedStrings.spo + ' (' + LocalizedStrings._import + ')';
